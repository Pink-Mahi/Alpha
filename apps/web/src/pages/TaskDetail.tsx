...
function EventRow({ event }: { event: AgentEvent }) {
  ...
  switch (event.type) {
    ...
    case "tool.call": {
      ...
      const color = isBrowser ? "#1f6feb" : isWeb ? "#a371f7" : isMemory ? "#238636" : isVision ? "#f0883e" : isCode ? "#d29922" : isHttp ? "#1f6feb" : isDeploy ? "#238636" : isImage ? "#f0883e" : isDb ? "#1f6feb" : isNotify ? "#d29922" : isTest ? "#238636" : isMobile ? "#f0883e" : isGitAdv ? "#f85149" : isDocker ? "#1f6feb" : isCodeAnalyze ? "#a371f7" : isSecurity ? "#f85149" : isDocs ? "#238636" : isScaffold ? "#1f6feb" : isData ? "#d29922" : isPkg ? "#238636" : isMath ? "#a371f7" : isPhysics ? "#1f6feb" : isChem ? "#238636" : isSciConst ? "#f0883e" : "#d29922";
      return (
