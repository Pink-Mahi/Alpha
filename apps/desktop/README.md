# ALPHA Desktop (VS Code fork)

Fork of VS Code (microsoft/vscode @ 1.99.3) for the ALPHA agentic coding IDE.

## Layout
```
apps/desktop/
  product.json          # ALPHA branding/product config (overrides upstream's)
  vscode/               # upstream VS Code source (cloned, depth=1, tag 1.99.3)
  extensions/ALPHA/   # our built-in ALPHA extension (agent panel, command center)
...
## License
VS Code is MIT-licensed. Our changes and the ALPHA extension are closed-source
