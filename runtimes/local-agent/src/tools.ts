...
import { stockIndicators, stockOptions, stockData, stockPredict, stockStrategies, stockMarket, stockVolatility, stockScanner, stockEvents, stockPortfolio, stockBacktest } from "./stockTools.js";
...
export function registerBuiltinTools(bus: import("./toolBus.js").ToolBus, router?: ModelRouterClient, defaultModel?: string, apiKey?: string): void {
  ...
  bus.register(stockOptions);
  bus.register(stockData);
  bus.register(stockPredict);
  bus.register(stockStrategies);
  bus.register(stockMarket);
  bus.register(stockVolatility);
  bus.register(stockScanner);
  bus.register(stockEvents);
  bus.register(stockPortfolio);
  bus.register(stockBacktest);
}
