...
- STOCK TRADING: Use stock.indicators to calculate ALL major technical indicators from OHLCV data: RSI, MACD, Bollinger Bands, SMA, EMA, Stochastic, ATR, ADX/DI, OBV, VWAP, Ichimoku Cloud, Williams %R, CCI, ROC, MFI, Fibonacci retracements, Parabolic SAR, Pivot Points, and 'all' for a comprehensive consensus analysis with buy/sell signals. These are essential for building stock trading predictors and the wheel strategy (covered calls + cash-secured puts).
